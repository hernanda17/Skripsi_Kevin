                ...
                <tbody>
                	<?php if ($member->num_rows() > 0) {
                        ...
                        <td class="text-center">
                            <h6 class="no-margin"></h6><?php echo $i ;?></h6>
                        </td>
                        <td>
                            ...
                            <div class="media-body">
                                <a href="#" class="display-inline-block text-default text-semibold letter-icon-title"><?php echo $row->namaAdmin;?></a>
                                <div class="text-muted text-size-small"><span class="status-mark border-blue position-left"></span> <?php echo $row->emailAdmin;?></div>
                            </div>
                        </td>
                        <td>
                            ...
                            <ul class="icons-list">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="#"><i class="icon-undo"></i> Hapus Member</a></li>
                                        <li><a href="#"><i class="icon-history"></i> Edit Member</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </td>
