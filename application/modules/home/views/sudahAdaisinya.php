	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				<li>
					<a class="sidebar-control sidebar-main-toggle hidden-xs" data-popup="tooltip" title="" data-placement="bottom" data-container="body" data-original-title="Collapse main">
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								...
								<div class="media-body">
									<span class="media-heading text-semibold">Nama Admin</span>
									<div class="text-size-mini text-muted">
										<i class="icon-mail5"></i>    Email
									</div>
								</div>
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<pre class=" content-group language-markup" data-line="2"></pre>
